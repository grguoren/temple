...
function GetDataById_Ajax() {
    $.ajax({
        ...
        success: function (ajaxData) {
            ...
            DataAddOrUpdate.NewModel.OnBoardDate = avalon.filters.date(ajaxData.OnBoardDate, "yyyy-MM-dd HH:mm");
            DataAddOrUpdate.NewModel.Passwd = ajaxData.Passwd;
            DataAddOrUpdate.NewModel.ResignationDate = ajaxData.ResignationDate !=null?avalon.filters.date(ajaxData.ResignationDate, "yyyy-MM-dd HH:mm"):"";
            ...
            console.log(DataAddOrUpdate.NewModel.FileName);
