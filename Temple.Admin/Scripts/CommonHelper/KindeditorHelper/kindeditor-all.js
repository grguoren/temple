...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		fileManagerJson = K.undef(self.fileManagerJson, self.basePath + 'asp.net/file_manager_json.ashx'),
		uploadJson = K.undef(self.uploadJson, self.basePath + 'asp.net/upload_toimgSvr.ashx');
	self.plugin.flash = {
		edit : function() {
			var html = [
				...
				yesBtn : {
					...
					click : function(e) {
						...
						if (url.slice(-4).toUpperCase() == '.FLV') {
						    var flashvars='file=' + url + '&autostart=' + (autostartBox[0].checked ? 'true' : 'false') + ''
						    html = K.mediaImg(self.themesPath + 'common/blank.gif', {
						        src: 'http://img.zx58.cn/Scripts/FlvPlayer.swf?' + flashvars,
