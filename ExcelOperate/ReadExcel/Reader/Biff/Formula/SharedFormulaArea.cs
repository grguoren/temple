...
namespace ExcelOperate.Biff.Formula
{
	...
	class SharedFormulaArea:Operand, ParsedThing
	{
		...
		{
			ExcelOperate.Biff.CellReferenceHelper.getCellReference(columnFirst, rowFirst, buf);
			buf.Append(':');
			ExcelOperate.Biff.CellReferenceHelper.getCellReference(columnLast, rowLast, buf);
		}
	}
}
