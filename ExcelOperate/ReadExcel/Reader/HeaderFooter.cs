...
using Contents = ExcelOperate.Biff.HeaderFooter.Contents;
namespace ExcelOperate.ReadExcel
{
	
	/// <summary> Class which represents an Excel header or footer. </summary>
    public sealed class HeaderFooter : ExcelOperate.Biff.HeaderFooter
	{
		...
		//   */
        //  public static class Contents extends ExcelOperate.Biff.HeaderFooter.Contents
		//  {
		////    /**
		////     * The constructor
		////     */
        ...
        protected internal override ExcelOperate.Biff.HeaderFooter.Contents createContents()
		{
			return new Contents(this);
		}
		
		/// <summary> Creates internal class of the appropriate type</summary>
        protected internal override ExcelOperate.Biff.HeaderFooter.Contents createContents(string s)
		{
			return new Contents(this, s);
		}
		
		/// <summary> Creates internal class of the appropriate type</summary>
        protected internal override ExcelOperate.Biff.HeaderFooter.Contents createContents(ExcelOperate.Biff.HeaderFooter.Contents c)
		{
