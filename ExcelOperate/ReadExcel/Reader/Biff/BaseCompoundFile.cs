	...
	public abstract class BaseCompoundFile
	{
		...
		protected internal class PropertyStorage
		{
			...
			virtual public int Type
			{
				...
				{
					type = value;
                    data[ExcelOperate.Biff.BaseCompoundFile.TYPE_POS] = (sbyte)value;
                    data[ExcelOperate.Biff.BaseCompoundFile.TYPE_POS + 1] = (sbyte)(0x1);
				}
			...
			virtual public int StartBlock
			{
				...
				{
					startBlock = value;
                    IntegerHelper.getFourBytes(value, data, ExcelOperate.Biff.BaseCompoundFile.START_BLOCK_POS);
				}
			...
			virtual public int Size
			{
				...
				{
					size = value;
                    IntegerHelper.getFourBytes(value, data, ExcelOperate.Biff.BaseCompoundFile.SIZE_POS);
				}
			...
			virtual public int Previous
			{
				...
				{
					previous = value;
                    IntegerHelper.getFourBytes(value, data, ExcelOperate.Biff.BaseCompoundFile.PREVIOUS_POS);
				}
			...
			virtual public int Next
			{
				...
				{
					next = value;
                    IntegerHelper.getFourBytes(next, data, ExcelOperate.Biff.BaseCompoundFile.NEXT_POS);
				}
			...
			virtual public int Directory
			{
				...
				{
					directory = value;
                    IntegerHelper.getFourBytes(directory, data, ExcelOperate.Biff.BaseCompoundFile.DIRECTORY_POS);
				}
			...
			public PropertyStorage(BaseCompoundFile enclosingInstance, sbyte[] d)
			{
				...
				data = d;
                int nameSize = IntegerHelper.getInt(data[ExcelOperate.Biff.BaseCompoundFile.SIZE_OF_NAME_POS], data[ExcelOperate.Biff.BaseCompoundFile.SIZE_OF_NAME_POS + 1]);
                type = data[ExcelOperate.Biff.BaseCompoundFile.TYPE_POS];

                startBlock = IntegerHelper.getInt(data[ExcelOperate.Biff.BaseCompoundFile.START_BLOCK_POS], data[ExcelOperate.Biff.BaseCompoundFile.START_BLOCK_POS + 1], data[ExcelOperate.Biff.BaseCompoundFile.START_BLOCK_POS + 2], data[ExcelOperate.Biff.BaseCompoundFile.START_BLOCK_POS + 3]);
                size = IntegerHelper.getInt(data[ExcelOperate.Biff.BaseCompoundFile.SIZE_POS], data[ExcelOperate.Biff.BaseCompoundFile.SIZE_POS + 1], data[ExcelOperate.Biff.BaseCompoundFile.SIZE_POS + 2], data[ExcelOperate.Biff.BaseCompoundFile.SIZE_POS + 3]);
			...
			{
				InitBlock(enclosingInstance);
                data = new sbyte[ExcelOperate.Biff.BaseCompoundFile.PROPERTY_STORAGE_BLOCK_SIZE];
				
				Assert.verify(name.Length < 32);

                IntegerHelper.getTwoBytes((name.Length + 1) * 2, data, ExcelOperate.Biff.BaseCompoundFile.SIZE_OF_NAME_POS);
