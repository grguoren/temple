...
namespace ExcelOperate.Biff
{
    ...
    public class XFRecord : WritableRecordData, ExcelOperate.Format.CellFormat
	{
		...
		/// <returns> the format
		/// </returns>
        virtual public ExcelOperate.Format.Format Format
		{
			get
			{
				if (!formatInfoInitialized)
		...
		/// </summary>
        private ExcelOperate.Format.Format excelFormat;
        ...
        public XFRecord(FontRecord fnt, DisplayFormat form)
            : base(ExcelOperate.Biff.Type.XF)
		{
