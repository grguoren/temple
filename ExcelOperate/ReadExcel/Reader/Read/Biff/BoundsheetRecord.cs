	...
	class BoundsheetRecord:RecordData
	{
		...
		public BoundsheetRecord(Record t):base(t)
		{
			...
			if (data[7] == 0)
			{
                ...
                name = new string(ExcelOperate.Utils.Byte.ToCharArray(ExcelOperate.Utils.Byte.ToByteArray(bytes)));
			}
			else
			{
				...
				try
				{
                    ...
                    //					name = new string(ExcelOperate.Utils.Byte.ToCharArray(ExcelOperateUtils.Byte.ToByteArray(bytes)));
