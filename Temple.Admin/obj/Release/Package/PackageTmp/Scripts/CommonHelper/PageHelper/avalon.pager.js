...
define(["avalon",
        ...
        var vmodel = avalon.define(data.pagerId, function(vm) {
            ...
            vm.jumpPage = function (event, page) {
                ...
                if (page !== vm.currentPage) {
                    ...
                    if (this.className.indexOf("disabled") === -1) {//原状态是state-disabled
    ...
    widget.defaults = {
        ...
        ellipseText: "<li><a href=\"#\">...</a></li>", //@config {String} 省略的页数用什么文字表示 
