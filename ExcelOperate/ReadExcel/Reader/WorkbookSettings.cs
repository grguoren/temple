...
namespace ExcelOperate.ReadExcel
{
	...
	public sealed class WorkbookSettings
	{
        ...
        /// from abroad.  This may also be set using the system property ExcelOperate.encoding
		/// </summary>
...
//			try
//			{
            //				      boolean suppressWarnings = Boolean.getBoolean("NExExcelOperatecel.nowarnings");
//				      setSuppressWarnings(suppressWarnings);
            //				      drawingsDisabled        = Boolean.getBoolean("ExcelOperate.nodrawings");
            //				      namesDisabled           = Boolean.getBoolean("ExcelOperate.nonames");
            //				      gcDisabled              = Boolean.getBoolean("ExcelOperate.nogc");
            //				      rationalizationDisabled = Boolean.getBoolean("ExcelOperate.norat");
//				      formulaReferenceAdjustDisabled =
            //				                                Boolean.getBoolean("ExcelOperate.noformulaadjust");
//				
...
//			}
			...
			try
			{
                ...
                //	  if (System.getProperty("ExcelOperate.lang")    == null ||
                //          System.getProperty("ExcelOperate.country") == null)
				//      {
				//        locale = Locale.getDefault();
				//      }
				//      else
				//      {
                //        locale = new Locale(System.getProperty("ExcelOperate.lang"),
                //                            System.getProperty("ExcelOperate.country"));
				//      }
				//
                //      if (System.getProperty("ExcelOperate.encoding") != null)
				//      {
                //        encoding = System.getProperty("ExcelOperate.encoding");
				//      }
