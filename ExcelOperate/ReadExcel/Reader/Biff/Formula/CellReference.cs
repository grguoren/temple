...
namespace ExcelOperate.Biff.Formula
{
	...
	class CellReference:Operand, ParsedThing
	{
		...
		{
			column = ExcelOperate.Biff.CellReferenceHelper.getColumn(s);
			row = ExcelOperate.Biff.CellReferenceHelper.getRow(s);
			columnRelative = ExcelOperate.Biff.CellReferenceHelper.isColumnRelative(s);
			rowRelative = ExcelOperate.Biff.CellReferenceHelper.isRowRelative(s);
		}
		...
		{
			ExcelOperate.Biff.CellReferenceHelper.getCellReference(column, !columnRelative, row, !rowRelative, buf);
		}
