...
using System.IO;
using System.Text;
using ExcelOperate.MyOle2;
using ExcelOperate.Metadata;
...
{
    /// <summary>
    /// The root class of ExcelOperate, containing general configuration properties and references to
    ...
    public class XlsDocument
    {
        ...
        /// from the file as possible and representing it appropriately with ExcelOperate objects
        ...
        internal XlsDocument(string fileName, Workbook.BytesReadCallback workbookBytesReadCallback)
        {
            ...
            _workbook = new Workbook(this, _ole2Doc.Streams[_ole2Doc.Streams.GetIndex(  ExcelOperate.MyOle2.Directory.Biff8Workbook)].Bytes, workbookBytesReadCallback);
        }
        ...
        public XlsDocument(System.IO.Stream stream)
        {
            ...
            //TODO: SummaryInformationSection and DocumentSummaryInformationSections should be read by MyOle2
            _workbook = new Workbook(this, _ole2Doc.Streams[_ole2Doc.Streams.GetIndex(  ExcelOperate.MyOle2.Directory.Biff8Workbook)].Bytes, null);
        }
        ...
        /// <summary>
        /// Gets this  ExcelOperate XlsDocument's OLE2 Document.
        /// </summary>
        public MyOle2.Ole2Document OLEDoc { get { return _ole2Doc; } }

        /// <summary>
        /// Gets this  ExcelOperate XlsDocument's Workbook.
        /// </summary>
        ...
        /// ExcelOperate, this is always true.
        /// </summary>
