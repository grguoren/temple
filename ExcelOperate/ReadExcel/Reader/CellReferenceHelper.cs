...
namespace ExcelOperate.ReadExcel
{
    ...
    //import ExcelOperate.Write.WritableWorkbook;
	...
	public sealed class CellReferenceHelper
	{
		...
		{
            ExcelOperate.Biff.CellReferenceHelper.getCellReference(column, row, buf);
		}
		...
		{
            ExcelOperate.Biff.CellReferenceHelper.getCellReference(column, colabs, row, rowabs, buf);
		}
		...
		{
            return ExcelOperate.Biff.CellReferenceHelper.getCellReference(column, row);
		}
		...
		{
            return ExcelOperate.Biff.CellReferenceHelper.getColumn(s);
		}
		...
		{
            return ExcelOperate.Biff.CellReferenceHelper.getColumnReference(c);
		}
		...
		{
            return ExcelOperate.Biff.CellReferenceHelper.getRow(s);
		}
		...
		{
            return ExcelOperate.Biff.CellReferenceHelper.isColumnRelative(s);
		}
		...
		{
            return ExcelOperate.Biff.CellReferenceHelper.isRowRelative(s);
		}
		...
		{
            ExcelOperate.Biff.CellReferenceHelper.getCellReference(sheet, column, row, (ExcelOperate.Biff.Formula.ExternalSheet)workbook, buf);
		}
		...
		//  {
        //    ExcelOperate.Biff.CellReferenceHelper.getCellReference
        //      (sheet, column, row, (ExcelOperate.Biff.Formula.ExternalSheet)workbook, buf);
		//  }
		...
		{
            ExcelOperate.Biff.CellReferenceHelper.getCellReference(sheet, column, colabs, row, rowabs, (ExcelOperate.Biff.Formula.ExternalSheet)workbook, buf);
		}
		...
		{
            return ExcelOperate.Biff.CellReferenceHelper.getCellReference(sheet, column, row, (ExcelOperate.Biff.Formula.ExternalSheet)workbook);
		}
		...
		//  {
        //    return ExcelOperate.Biff.CellReferenceHelper.getCellReference
        //      (sheet, column, row, (ExcelOperate.Biff.Formula.ExternalSheet)workbook);
		//  }
	}
}
