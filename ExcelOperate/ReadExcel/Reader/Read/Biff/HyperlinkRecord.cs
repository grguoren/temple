		...
		internal HyperlinkRecord(Record t, Sheet s, WorkbookSettings ws):base(t)
		{
			...
			if ((data[28] & 0x3) == 0x03)
			{
				...
				catch (Exception e)
				{
                    ...
                    ExcelOperate.ReadExcel.CellReferenceHelper.getCellReference(firstColumn, firstRow, sb1);
                    ExcelOperate.ReadExcel.CellReferenceHelper.getCellReference(lastColumn, lastRow, sb2);
