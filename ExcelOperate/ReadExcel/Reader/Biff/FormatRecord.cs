...
namespace ExcelOperate.Biff
{
    ...
    public class FormatRecord : WritableRecordData, DisplayFormat, ExcelOperate.Format.Format
	{
...
//					csb.Append("ss.SSS");
        ...
        internal FormatRecord(string fmt, int refno)
            : base(ExcelOperate.Biff.Type.FORMAT)
		{
			formatString = fmt;
			indexCode = refno;
			initialized = true;
		...
		public FormatRecord(Record t, WorkbookSettings ws, BiffType biffType):base(t)
		{
			...
			else
			{
                ...
                formatString = new string(ExcelOperate.Utils.Byte.ToCharArray(ExcelOperate.Utils.Byte.ToByteArray(chars)));
			}
