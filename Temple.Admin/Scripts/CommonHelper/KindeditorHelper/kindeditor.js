...
(function (window, undefined) {
        ...
        html = html.replace(re, function ($0, $1, $2, $3, $4, $5, $6) {
            ...
            if (attr !== '') {
                ...
                _each(attrMap, function (key, val) {
                    ...
                    if (htmlTags && key !== 'style' && key !== 'flashvars' && key !== "allowfullscreen" && key !== "pluginspage" && !htmlTagMap[tagName]['*'] && !htmlTagMap[tagName][key] ||
    ...
    function _mediaEmbed(attrs) {
        ...
        _each(attrs, function (key, val) {
            ...
            if (key == "src" && val.lastIndexOf("flv") < 0) {
                flag = 1;
                if (val.lastIndexOf("wmv") > 0 || val.lastIndexOf("avi") > 0 || val.lastIndexOf("mp3") > 0 || val.lastIndexOf("wma") > 0) {
                    html += ' pluginspage="http://www.microsoft.com/Windows/MediaPlayer/"  ';
                } else if (val.lastIndexOf("swf") > 0) {
            ...
            if (flag == 1) {
                ...
                switch (key) {
                    ...
                    case "src": path = val; break;
                    case "autostart": if (val == "false") isautostart = 0; break;
                }
        ...
        if (flag == 0)
            html = '<embed src="http://www.zx58.cn/images/Flvplayer.swf"  flashvars="vcastr_file=' + path + '&LogoText=&IsAutoPlay=' + isautostart + '" allowFullScreen="true" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="' + width + '" height="' + height + '" />';
        else
            html += ' />';
