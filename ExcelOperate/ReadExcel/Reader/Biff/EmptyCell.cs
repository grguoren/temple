...
namespace ExcelOperate.Biff
{
	...
	public class EmptyCell : WritableCell
	{
		...
		/// </param>
        virtual public ExcelOperate.Write.VerticalAlignment VerticalAlignment
		{
			set
			{
			}
		...
		/// </returns>
        public virtual ExcelOperate.Format.CellFormat CellFormat
		{
		get
		{
		return null;
		...
		/// </param>
        public virtual void setBorder(ExcelOperate.Write.Border border, ExcelOperate.Write.BorderLineStyle line)
		{
		}
		...
		/// <param name="cf">dummy
		/// </param>
        public virtual void setCellFormat(ExcelOperate.Format.CellFormat cf)
		{
		}
		...
		/// <deprecated>
		/// </deprecated>
        public virtual void setCellFormat(ExcelOperate.ReadExcel .CellFormat cf)
		{
		}
