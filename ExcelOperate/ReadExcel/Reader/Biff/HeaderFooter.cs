...
using System;
using Assert = ExcelOperate.common.Assert;
using Logger = ExcelOperate.common.Logger;
namespace ExcelOperate.Biff
{
	...
	public abstract class HeaderFooter
	{
		...
		public class Contents
		{
			...
			{
                appendInternal(ExcelOperate.Biff.HeaderFooter.BOLD_TOGGLE);
			}
			...
			{
                appendInternal(ExcelOperate.Biff.HeaderFooter.UNDERLINE_TOGGLE);
			}
			...
			{
                appendInternal(ExcelOperate.Biff.HeaderFooter.ITALICS_TOGGLE);
			}
			...
			{
                appendInternal(ExcelOperate.Biff.HeaderFooter.STRIKETHROUGH_TOGGLE);
			}
			...
			{
                appendInternal(ExcelOperate.Biff.HeaderFooter.DOUBLE_UNDERLINE_TOGGLE);
			}
			...
			{
                appendInternal(ExcelOperate.Biff.HeaderFooter.SUPERSCRIPT_TOGGLE);
			}
			...
			{
                appendInternal(ExcelOperate.Biff.HeaderFooter.SUBSCRIPT_TOGGLE);
			}
			...
			{
                appendInternal(ExcelOperate.Biff.HeaderFooter.OUTLINE_TOGGLE);
			}
			...
			{
                appendInternal(ExcelOperate.Biff.HeaderFooter.SHADOW_TOGGLE);
			}
