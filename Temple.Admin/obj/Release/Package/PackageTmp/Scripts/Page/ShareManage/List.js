...
var newsList = avalon.define('newsList', function (vm) {
    ...
    vm.getList = function (page) {
        ...
        $.ajax({
            ...
            data: { isuser: 6, page: vm.List_Page, size: vm.pager.perPages, bid: vm.Search_BrandId, typeid: vm.Search_TypeId, status: vm.Search_StatusId, keytype: vm.Search_SearchTypeId, keyword: vm.Search_Title, scid: vm.Search_scId },
            timeout: 200000,
    ...
    vm.getTopStatus = function (istop, topBengTime, qTopEndTime) {
        ...
        //alert(endtime + "|" + bengtime + "|" + nowtime);
